...
# Round predictions to nearest integer and clip to valid range [0, 2]
...
while True:
    ...
    # Extract features for the new word
    length = len(word)
    ...
    x_new = [[
        ...
        ends_es,
        ends_ies,
        1,  # Count (just use 1 for unseen words)
        is_alpha,
        has_digit,
        has_nonalpha,
        vowel_ratio,
    ...
    y_new_pred = regressor.predict(poly_reg.transform(x_new))[0]

    # Round to nearest label (0,1,2)
